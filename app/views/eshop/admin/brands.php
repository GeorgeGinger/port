...
<div class="content-panel">
					...
					<div class="form-panel">
						...
						<form class="form-horizontal style-form" method="get">
							...
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label" for="brand">Brand name</label>
								<div class="col-sm-10">
		...
		<?php else: ?>
			...
			<div>
				<h2 style="text-align: center">No brands.</h2>
			</div>
...
<script>
	...
	function collect_data(obj = {}) {
		...
		if (data.brand == "" || !isNaN(data.brand)) {
			alert("Please enter a valid brand name js");
			return;
		}

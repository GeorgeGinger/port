	...
	<div class="col-lg-12">
		<div class="form-panel">
			...
			<form class="form-horizontal style-form" method="get">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="email" id="email"
							placeholder="Enter email" style="margin-bottom: 1rem">
					</div>
				</div>

				<div class="form-group">
					<label class="col-sm-2 col-sm-2 control-label" for="last_name">Last_name</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label class="col-sm-2 col-sm-2 control-label" for="email">Rank</label>
					<div class="col-sm-10">
...
<script>
	...
	function collect_data(obj = {}) {
		...
		data.last_name = last_name_input.value.trim();
		data.data_type = obj.data_type;
		data.id		= EDIT_ID;
		...
		// prazdny retezec nebo neni cislo
		if (data.last_name == "" || !isNaN(data.last_name)) {
			alert("Please enter a valid name last_name js");
			return;
		}

		if (!isNaN(data.email)) {
			alert("Please enter a valid email js");
			return;
		}
	...
	function edit_row(e) {
		...
		email_input.value 	 = obj.email;
		rank_input.value 	 = obj.rank;
		last_name_input.value 	 = obj.last_name;
...
let row = e.target.emailNode;

let details = row.querySelector(".js_order_details");

// pokud kliknu na close pak details == null protoze email pro div s close neobsahuje .js_order_details
if(details) {

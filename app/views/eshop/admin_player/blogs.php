<?php $this->view("admin_player/header", $data); ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<!-- <input type="text" class="form-control" name="post" id="post"
									placeholder="Enter blog post" style="margin-bottom: 1rem"> -->
							</div>
						</div>
...
<script>
	...
	function collect_data(obj = {}) {
		...
		if (data.post == "" || !isNaN(data.post)) {
			alert("Please enter a valid post js" + data.header1);
			return;
		}
...
<?php $this->view("admin_player/footer", $data); ?>